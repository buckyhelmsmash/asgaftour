  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        <form action="<?= base_url('admin/destinasi/add/' . $detail_negara->id_negara) ?>" method="post" id="form-destinasi">
          <!-- Text input-->
...
<div class="modal fade" id="tambahhotel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        <form action="<?= base_url('admin/hotel/add/' . $detail_negara->id_negara) ?>" method="post">
          <!-- Text input-->
          <div class="form-group">
